...
prov_sigla <- iflese(is.na(params$provincia),
                     "RE",
                     params$provincia)                  # sigla di Reggio Emilia
data_selezionata <- ifelse(is.na(params$data), 
                           format(Sys.Date()-5, "%d/%m/%Y"),
                           params$data)               # data scelta
