...
Compagno, ricordati che questo progetto è dimostrativo e satirico.  
...
L'obiettivo è mostrare la potenza collettiva di `R`, `Quarto` e dell'automazione open source!
...
<p></p>
  ...
  build_time <- Sys.getenv("GITHUB_RUN_TIMESTAMP")  # esempio, vedremo come impostarla
  if (nzchar(build_time)) {
    ...
    cat('<p style="text-align:center; font-size: 0.9em; color: #555;"> Ultimo aggiornamento automatico: <strong>dato non disponibile</strong></p>')
  }
  ```
```
